...
- En `K3`, écrire `MOYENNE.SI(A:A;"<=50K";D:D)` et en `L3`, écrire `MOYENNE.SI(A:A;" >50K";D:D)`
...
- En `K5` et en `I5`, écrire `NB(A:A)`
- Pour `K7` et `L7`, on écrit la valeur $5$ 
- Pour `K8` et `L8`, on écrire `LOI.NORMALE.INVERSE.N(1-H18/2/100; 0; 1)`
- Pour `K10`, on écrit `K3-K8*RACINE(K4/K5)` (idem pour `L10` avec des `I` au lieu des `K`)
- Pour `K11`, on écrit `K3+K8*RACINE(K4/K5)` (idem pour `L10` avec des `I` au lieu des `K`)
